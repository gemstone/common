...
namespace Gemstone.Common.UnitTests.ArrayExtensions
{
    [TestClass]
    public class CountOfSequenceTest
    {
        ...
        /// </summary>
        [TestMethod]
        public void Count1Start20MidAndEnd()
        {
        ...
        /// </summary>
        [TestMethod]
        public void Count2Start5MidAndEnd()
        {
            const string lookFor = "GHI";
