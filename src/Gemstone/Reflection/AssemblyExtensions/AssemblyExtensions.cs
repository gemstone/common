...
namespace Gemstone.Reflection.AssemblyExtensions
{
    ...
    public static class AssemblyExtensions
    {
        ...
        public static string ShortName(this Assembly instance) => instance.FullName.Split(',')[0];
        ...
        public static Stream GetEmbeddedResource(this Assembly instance, string resourceName) => instance.GetManifestResourceStream(resourceName);
        ...
        public static string Title(this Assembly instance) => new AssemblyInfo(instance).Title;
        ...
        public static string Description(this Assembly instance) => new AssemblyInfo(instance).Description;
        ...
        public static string Company(this Assembly instance) => new AssemblyInfo(instance).Company;
        ...
        public static string Product(this Assembly instance) => new AssemblyInfo(instance).Product;
        ...
        public static string Copyright(this Assembly instance) => new AssemblyInfo(instance).Copyright;
        ...
        public static string Trademark(this Assembly instance) => new AssemblyInfo(instance).Trademark;
        ...
        public static string Configuration(this Assembly instance) => new AssemblyInfo(instance).Configuration;
        ...
        public static bool DelaySign(this Assembly instance) => new AssemblyInfo(instance).DelaySign;
        ...
        public static string InformationalVersion(this Assembly instance) => new AssemblyInfo(instance).InformationalVersion;
        ...
        public static string KeyFile(this Assembly instance) => new AssemblyInfo(instance).KeyFile;
        ...
        public static string CultureName(this Assembly instance) => new AssemblyInfo(instance).CultureName;
        ...
        public static string SatelliteContractVersion(this Assembly instance) => new AssemblyInfo(instance).SatelliteContractVersion;
        ...
        public static string ComCompatibleVersion(this Assembly instance) => new AssemblyInfo(instance).ComCompatibleVersion;
        ...
        public static bool ComVisible(this Assembly instance) => new AssemblyInfo(instance).ComVisible;
        ...
        public static bool Debuggable(this Assembly instance) => new AssemblyInfo(instance).ComVisible;
        ...
        public static string Guid(this Assembly instance) => new AssemblyInfo(instance).Guid;
        ...
        public static DateTime BuildDate(this Assembly instance) => new AssemblyInfo(instance).BuildDate;
        ...
        public static string RootNamespace(this Assembly instance) => new AssemblyInfo(instance).RootNamespace;
        ...
        public static NameValueCollection GetAttributes(this Assembly instance) => new AssemblyInfo(instance).GetAttributes();
