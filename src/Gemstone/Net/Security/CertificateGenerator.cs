...
namespace Gemstone.Net.Security
{
    ...
    public class CertificateGenerator
    {
        ...
        /// </summary>
        public CertificateGenerator() => m_debugLog = new List<string>();
        ...
        public X509Certificate2 GenerateCertificate()
        {
            ...
            try
            {
                ...
                {
                    storedCertificates = stores.SelectMany(store => store.Certificates).ToList();
            ...
            if (File.Exists(makeCertPath))
            {
                foreach (X509Store store in stores)
                {
                    ...
                    if (File.Exists(certificatePath))
                        ...
                        m_debugLog.Add($"Attempting to generate a new certificate in the {store.Location} store... failed");
        ...
        public void ExportCertificateWithPrivateKey(string exportPath, SecureString password)
        {
            ...
            List<X509Certificate2> certificates = store.Certificates.ToList();
