...
namespace Gemstone.Security.Cryptography
{
    ...
    public class PasswordGenerator
    {
        ...
        /// </summary>
        public int MinLength => CharacterGroups.Sum(characterGroup => characterGroup.MinOccurrence);
        ...
        public string GeneratePassword() => GeneratePassword(Math.Max(8, MinLength));
