...
//       2.0 version of source code migrated from 1.1 source (Gemstone.Interop.Windows.IniFile).
...
public class IniFile
{
    ...
    {
        m_iniFile = Common.IsPosixEnvironment ? new UnixIniFile(fileName) : new WindowsIniFile(fileName);
    }
    ...
    internal static string RemoveComments(string keyValue)
    {
        ...
        if (commentIndex > -1)
            keyValue = keyValue[..commentIndex].Trim();
