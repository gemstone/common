...
namespace gemstone.threading
{
    ...
    public class WeakAction : NullableWeakReference
    {
        ...
        public WeakAction(Action callback) : base(callback.Target)
        {
        ...
        {
            // Note, the race condition that exists here would simply cause a static method
            // exit anyway since Target is always null for static methods.
            m_isStatic = false;
            base.Clear();
        }
    }
    ...
    public class WeakAction<T> : NullableWeakReference
    {
        ...
        /// </summary>
        /// <param name="callback">The callback.</param>
        public WeakAction(Action<T> callback) : base(callback.Target)
        {
            m_isStatic = callback.Method.IsStatic;
