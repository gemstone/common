...
namespace gemstone.threading
{
    ...
    internal class ThreadContainerDedicated : ThreadContainerBase
    {
        ...
        public ThreadContainerDedicated(Action<CallbackArgs> callback, Action disposeAndWaitCallback, bool isBackground, ThreadPriority priority, bool disposeOnShutdown) : base(callback, disposeAndWaitCallback, disposeOnShutdown)
        {
        ...
        protected override void InternalStart_FromWorkerThread() => m_shouldReRunImmediately = true;
        ...
        protected override void InternalDispose_FromWorkerThread() => m_shouldQuit = true;
    }
}
