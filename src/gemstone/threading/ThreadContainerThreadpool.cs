...
namespace gemstone.threading
{
    ...
    internal class ThreadContainerThreadpool : ThreadContainerBase
    {
        /// <summary>
        /// Handle that is created when telling the thread-pool to do a delayed start.
        /// </summary>
        ...
        public ThreadContainerThreadpool(Action<CallbackArgs> callback, Action disposeAndWaitCallback, bool disposeOnShutdown) : base(callback, disposeAndWaitCallback, disposeOnShutdown)
        {
        ...
        protected override void InternalCancelTimer() => m_waitObject.Set();

        protected override void InternalStart() => ThreadPool.QueueUserWorkItem(BeginRunImmediately);

        protected override void InternalStart_FromWorkerThread() => ThreadPool.QueueUserWorkItem(BeginRunImmediately);

        private void BeginRunImmediately(object state) => OnRunning();
