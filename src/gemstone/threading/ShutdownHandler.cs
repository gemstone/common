...
namespace gemstone.threading
{
    ...
    public static class ShutdownHandler
    {
        ...
        private static readonly List<WeakAction> s_onShutdownCallbackFirst = new List<WeakAction>();
        private static readonly List<WeakAction> s_onShutdownCallbackDefault = new List<WeakAction>();
        private static readonly List<WeakAction> s_onShutdownCallbackLast = new List<WeakAction>();
        ...
        private static void InitiateSafeShutdown(object sender, EventArgs e)
        {
            ...
            foreach (WeakAction weakAction in shutdownList)
            {
                ...
                {
                    Debug.WriteLine($"Application Shutdown Generated an Error: {ex.Message}");
                }
            }
        ...
        public static void InitiateSafeShutdown() => InitiateSafeShutdown(null, null);
    }
}
