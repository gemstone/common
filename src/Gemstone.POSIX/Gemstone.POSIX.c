...
// This will create a library and shared object for needed Gemstone functions
...
//      gcc -c -Wall -Werror -fpic Gemstone.POSIX.c
//
//	To compile as a shared object
//      gcc -shared -o Gemstone.POSIX.so Gemstone.POSIX.o -lpam -lpam_misc -lcrypt
//
//	To deploy shared object, e.g., copy to user libraries folder
//		sudo cp Gemstone.POSIX.so /usr/lib/
//
